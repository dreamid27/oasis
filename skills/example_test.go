...
// ExampleFromDir_basic demonstrates loading skills from a directory.
func ExampleFromDir_basic() {
...
`
	...
	provider := FromDir(filepath.Join(dir, "example"))
