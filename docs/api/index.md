...
| Doc | Contents |
|-----|----------|
| [interfaces.md](interfaces.md) | All exported interfaces (Agent, Provider, Store, Tool, Processor, etc.) |
| [types.md](types.md) | All exported types (ChatRequest, AgentTask, ToolResult, StreamEvent, etc.) |
