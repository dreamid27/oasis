...
func TestWithRetry_Chat_SucceedsFirstAttempt(t *testing.T) {
	...
	p := RetryMiddleware(RetryBaseDelay(0))(stub)
...
func TestWithRetry_Chat_ExhaustsMaxAttempts(t *testing.T) {
	...
	p := RetryMiddleware(RetryBaseDelay(0), RetryMaxAttempts(3))(stub)
...
func TestWithRetry_Chat_TimeoutExceeded(t *testing.T) {
	...
	p := RetryMiddleware(RetryBaseDelay(0), RetryTimeout(50*time.Millisecond))(stub)
...
func TestWithRetry_Chat_TimeoutAllowsSuccess(t *testing.T) {
	...
	p := RetryMiddleware(RetryBaseDelay(0), RetryTimeout(5*time.Second))(stub)
